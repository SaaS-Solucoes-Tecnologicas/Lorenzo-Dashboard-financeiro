...
# (A partir daqui continua o seu código de Resumo e Gráficos normalmente)
...
with st.form("form_novo_lancamento", clear_on_submit=True):
    ...
    with col2:
        categoria = st.selectbox("Categoria", ["Alimentação", "Transporte", "Moradia", "Lazer", "Salário", "Outros", "Trabalho", "Cofrinho", "Gasolina", "Projetos pess", "Supérfluo"])
    ...
    if submit:
        ...
        st.success("Lançamento salvo com sucesso! Atualize a página (pressione R) para ver na tabela.")
